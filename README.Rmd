...
The renderer checks the host revision before loading native code, loads both
extensions without downloads, and closes its duckknit session on success or error.
SQL errors fail the render. Edit `README.Rmd`; `README.md` contains executed output.
